...
public class TodoController {
	...
	@RequestMapping("/todo")
	public Todo getTodo(@RequestParam(value="description", defaultValue="Empty") String description) {
		return new Todo(description, false);
	}
	
	@GetMapping("/todos/{list_id}")
	public List<Todo> findAllTodosByListId(@PathVariable("list_id") Integer listId) {
